					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="/user/store" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                                        @csrf
                                        ...
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="tempat_lahir" id="first-name"  class="form-control ">
											</div>
										</div>
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="date" name="tgl_lahir" id="first-name"  class="form-control ">
											</div>
										</div>
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="pangkat_golongan" id="first-name"  class="form-control ">
											</div>
										</div>
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="jabatan" id="first-name"  class="form-control ">
											</div>
										</div>
                                        <div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="number" name="no_telepon" id="first-name"  class="form-control " required="required">
											</div>
										</div>
