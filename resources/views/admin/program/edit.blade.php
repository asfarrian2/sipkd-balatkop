		...
		<div class="x_content">
			...
			<form action="/program/update" method="POST" data-parsley-validate class="form-horizontal form-label-left">
				...
				<div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 ">
						<input type="text" name="program_baru" value="{{ $program->kode_program }}" id="first-name" required="required" class="form-control ">
					</div>
				</div>
                <div class="item form-group">
                ...
                <div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 ">
						<input type="text" name="pagu_program" value="{{ $program->pagu_program }}" id="pagu"  class="form-control ">
					</div>
                </div>
