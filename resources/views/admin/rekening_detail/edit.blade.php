...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
		...
		<div class="x_content">
		    <br>
			<form action="/rekeningdetail/update" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                @csrf
                <input type="text" hidden name="id_rekdet" value="{{ $data_rekening->id_rekdet }}" id=""  class="form-control ">
                <input type="text" hidden name="id_subdet" value="{{ $data_rekening->id_subdet }}" id=""  class="form-control ">
                <div class="item form-group">
					<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Uraian
					</label>
					<div class="col-md-6 col-sm-6 ">
						<input type="text" name="uraian" value="{{ $data_rekening->uraian_rekdet }}" id=""  class="form-control ">
					</div>
				</div>
                <div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 ">
						<input type="text" name="koefesien_rekdet" value="{{ $data_rekening->koefesien_rekdet }}" id=""  class="form-control ">
					</div>
				</div>
                <div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 ">
						<input type="text" name="satuan_rekdet" value="{{ $data_rekening->satuan_rekdet }}" id=""  class="form-control ">
					</div>
				</div>
                <div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 ">
						<input type="text" name="pagu_rekdet" value="{{ $data_rekening->pagu_rekdet }}" id="pagu2"  class="form-control ">
					</div>
				</div>
