...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
		...
		<div class="x_content">
		    <br>
			<form action="/sub_kegiatan/updatesubdet" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                @csrf
                ...
                <div class="item form-group">
					...
					<div class="col-md-6 col-sm-6 ">
						<input type="text" name="pagu_subdet" value="{{ $detail_subdet->pagu_subdet }}" id="pagu2"  class="form-control ">
					</div>
				</div>
