...
<div class="col-md-12 col-sm-12 ">
    <div class="x_panel">
        ...
        <br>
        <div class="col-md-4">
            <a href="/spj/create" class="btn btn-primary btn-sm" id="btntambahkoderekening">
                  ...
                  <div class="card-box table-responsive">
                      <table id="datatable" class="table table-striped table-bordered" width="100%">
                        ...
                        @csrf
                            ...
                            <a href="/up/edit/{{ $d->id_spj }}" title="Edit Data"><i class="fa fa-pencil text-succsess btn btn-warning btn-sm" ></i></a>
...
<script>
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location = "/up/"+id_spj+"/hapus"
        Swal.fire({
